...
class WeatherAPI(object):
    def __init__(self):
        self.url = 'https://free-api.heweather.net/s6/weather/forecast'
    ...
    def insert_data(self,weather_text):
        ...
        ins = 'insert into today_weather (province,city,district,date,' \
              'week,temperature_max,temperature_min,weather,wind_direct,wind_strength)' \
...
if __name__ == '__main__':
    try:
        api = WeatherAPI()
        api.run()
        with open('/home/tarena/桌面/weather_program/log/weather_today_insert.log' , 'a') as f:
